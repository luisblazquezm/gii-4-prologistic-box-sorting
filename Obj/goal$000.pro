...
clauses
	 ...
	 */		
  	apilar_caja_en_pila(Caja,PilaActual,NuevaPila):-
  		...
  		write(" --------- Actual: "), write(Actual), write(" - NuevoActual: "),
  		NuevoActual=Actual+1, /*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Da error en esta asignación */
  		write(NuevoActual), write("\n"),
	 ...
	 */
 	 ...
 	 */
  	colocar_cajas_en_almacen([Caja|RestoCajas],Almacen,NuevoAlmacen,Nivel):-
  		write("["), write(Nivel), write("] - "), write("PILA 1"),
  		recursividad_acotada(Nivel),
  		Almacen=alm(Pila1,Pila2,Pila3,Pila4,Pila5),
  		write(" ----- LLAMO A APILAR para meter caja ["), write(Caja), write("]\n"),
  		apilar_caja_en_pila(Caja,Pila1,NuevaPila1),
  		not(pila_invalida(NuevaPila1)),
  		write("------------ NuevaPila1: "), write(NuevaPila1), write("------------\n"),
  	...
  	colocar_cajas_en_almacen([Caja|RestoCajas],Almacen,NuevoAlmacen,Nivel):-
  		write("["), write(Nivel), write("] - "), write("PILA 2"),
  		recursividad_acotada(Nivel),
  		Almacen=alm(Pila1,Pila2,Pila3,Pila4,Pila5),
  		write(" ----- LLAMO A APILAR para meter caja ["), write(Caja), write("]\n"),
  	...
  	colocar_cajas_en_almacen([Caja|RestoCajas],Almacen,NuevoAlmacen,Nivel):-
  		write("["), write(Nivel), write("] - "), write("PILA 3"),
  		recursividad_acotada(Nivel),
  		Almacen=alm(Pila1,Pila2,Pila3,Pila4,Pila5),
  		write(" ----- LLAMO A APILAR para meter caja ["), write(Caja), write("]\n"),
  	...
  	colocar_cajas_en_almacen([Caja|RestoCajas],Almacen,NuevoAlmacen,Nivel):-
  		write("["), write(Nivel), write("] - "), write("PILA 4"),
  		recursividad_acotada(Nivel),
  		Almacen=alm(Pila1,Pila2,Pila3,Pila4,Pila5),
  		write(" ----- LLAMO A APILAR para meter caja ["), write(Caja), write("]\n"),
  	...
  	colocar_cajas_en_almacen([Caja|RestoCajas],Almacen,NuevoAlmacen,Nivel):-
  		write("["), write(Nivel), write("] - "), write("PILA 5"),
  		recursividad_acotada(Nivel),
  		Almacen=alm(Pila1,Pila2,Pila3,Pila4,Pila5),
  		write(" ----- LLAMO A APILAR para meter caja ["), write(Caja), write("]\n"),
  	 ...
  	 */
  	colocar_cajas_en_almacen([Caja|RestoCajas],Almacen,NuevoAlmacen,Nivel):-
  		write("["), write(Nivel), write("] - "), write("PILA FALLA"),
  		recursividad_acotada(Nivel),
  		Almacen=alm(_,_,_,_,Pila5),
  		write(" ----- LLAMO A APILAR para meter caja ["), write(Caja), write("]"),
  		write(" --- Lista de Produccion: "), write(RestoCajas), write("\n"),
  		apilar_caja_en_pila(Caja,Pila5,NuevaPila5),
	...
	/* Caso 1: si la pila esta vacia, el almacen queda en el mismo estado */
  	sacar_caja(Almacen,NuevoAlmacen,ListaProduccion,NuevaListaProduccion):-
  		write("CASO SACAR CAJA PILA 1 [PILA VACIA]\n"),
  	 ...
  	 */
  	sacar_caja(Almacen,NuevoAlmacen,ListaProduccion,NuevaListaProduccion):-
  		write("CASO SACAR CAJA PILA 1 [PILA NO VACIA]\n"),
  		Almacen=alm(Pila1,Pila2,Pila3,Pila4,Pila5),
